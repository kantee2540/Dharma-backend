...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>ระบบแก้ไขเว็บปฏิบัติธรรม</title>
        ...
        <script src="https://kit.fontawesome.com/c1364b564a.js" crossorigin="anonymous"></script>
        ...
        <link rel="stylesheet" href="{{ asset('css/dharma.css') }}">
